declare module "module_gm" {
    export abstract class DropdownItem extends UI.UIBehavior {
        list?: DropdownList<any>;
        data?: any;
    }
    interface IGMUI extends UI.UIBehavior {
        okButton: UI.Button;
        cmdPanel: UI.PanelWidget;
        dropList: UI.ScrollBox;
        argText: UI.InputBox;
        groupButton: UI.StaleButton;
        cmdButton: UI.StaleButton;
    }
...
declare module "module_gm" {
    export type GMData = {
        label: string;
        group: string;
        clientCmd?: (player: Gameplay.Player, value: string) => void;
        serverCmd?: (player: Gameplay.Player, value: string) => void;
        shortKey?: Type.Keys;
    };
     ...
     * @param shortKey 快捷键
     */
    export function AddGMCommand(label: string, cmdClient?: (player: Gameplay.Player, value: string) => void, cmdServer?: (player: Gameplay.Player, value: string) => void, group?: string, shortKey?: Type.Keys): void;
}

declare module "module_gm" {
    interface IGMItem extends DropdownItem {
        button: UI.StaleButton;
    }
    interface IGMUI extends UI.UIBehavior {
        okButton: UI.Button;
        cmdPanel: UI.PanelWidget;
